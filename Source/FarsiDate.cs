...
namespace DreamyTools.FarsiTools.WinControls.DrCalendar
{
    ...
    public class FarsiDate
    {
        ...
        /// </summary>
        [DefaultValue(typeof(string), ""), Description("")]
        public string Event
        {
            get { return _event; }
        ...
        public DateTime GregorianSelectedDate
        {
            ...
            set
            {
                FarsiSelectedDate = FarsiDateHelper.GetShortFarsiDate(value);
            }
        }
        ...
        /// <summary>
        /// Get the day of the persian week
        /// </summary>
        [Browsable(false)]
        public string FarsiDayName
        {
            get { return FarsiDateHelper.GetFarsiDayOfWeekName(GregorianSelectedDate); }
        }

        /// <summary>
        /// Get the persian month name of the persian calendar
        /// </summary>
        [Browsable(false)]
        public string FarsiMonthName
        {
            get { return FarsiDateHelper.GetFarsiMonthName(GregorianSelectedDate); }
        }
        ...
        {
            get { return FarsiDateHelper.IsHolidayFarsiDate(_pSelectedDate); }
        }
