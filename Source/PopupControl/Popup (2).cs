...
namespace DreamyTools.FarsiTools.Win.DrCalendar.PopupControl
{
    ...
    internal class Popup : ToolStripDropDown
    {
        ...
        protected override void OnVisibleChanged(EventArgs e)
        {
            ...
            if (this.Visible && this.ShowingAnimation == PopupAnimations.None || !this.Visible && this.HidingAnimation == PopupAnimations.None)
                return;
            global::DreamyTools.FarsiTools.Win.DrCalendar.PopupControl.NativeMethods.AnimationFlags animationFlags = this.Visible ? global::DreamyTools.FarsiTools.Win.DrCalendar.PopupControl.NativeMethods.AnimationFlags.Roll : global::DreamyTools.FarsiTools.Win.DrCalendar.PopupControl.NativeMethods.AnimationFlags.Hide;
            ...
            global::DreamyTools.FarsiTools.Win.DrCalendar.PopupControl.NativeMethods.AnimateWindow((Control)this, this.AnimationDuration, animationFlags | (global::DreamyTools.FarsiTools.Win.DrCalendar.PopupControl.NativeMethods.AnimationFlags)((PopupAnimations)1048575 & popupAnimations));
        }
        ...
        {
            var minmaxinfo = (NativeMethods.MINMAXINFO)Marshal.PtrToStructure(m.LParam, typeof(global::DreamyTools.FarsiTools.Win.DrCalendar.PopupControl.NativeMethods.MINMAXINFO));
